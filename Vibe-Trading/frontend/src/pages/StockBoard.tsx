/**
 * 个股看板 — watchlist + stock detail panel.
 *
 * Sub-components extracted to ./stock-board/:
 *   - StockDetailPanel  (fundamental analysis, 8 sections)
 *   - StockRow          (watchlist row)
 *   - SearchDialog      (add-stock modal)
...
import { StockDetailPanel, StockRow, SearchDialog, loadWatchlist, saveWatchlist, type WatchlistItem } from "./stock-board";
