/**
 * StockPick page helper functions and mock data generators.
 */
import type { KlineItem, PickStock, SectorDashboardData, TopStock } from "./types";
import { LOGIC_LABELS } from "./types";
...
export function generateMockKline(days: number): KlineItem[] {
